            ...
            _getOrCreateZendeskUser(client, user.displayName, userEmail, function(err, zenDeskUser) {
                ...
                var zenDeskTicket = {
                    'ticket': {
                        ...
                        'custom_fields': [
                            {'id': parseInt(ZenDeskConfig.getValue(tenantAlias, 'fields', 'externalId'), 10), 'value': ticket.externalId},
                            {'id': parseInt(ZenDeskConfig.getValue(tenantAlias, 'fields', 'downloadLink'), 10), 'value': downloadURL},
                            {'id': parseInt(ZenDeskConfig.getValue(tenantAlias, 'fields', 'publicationTitle'), 10), 'value': publication.displayName},
                            {'id': parseInt(ZenDeskConfig.getValue(tenantAlias, 'fields', 'department'), 10), 'value': publication.department},
                            {'id': parseInt(ZenDeskConfig.getValue(tenantAlias, 'fields', 'correspondingAuthor'), 10), 'value': publication.authors[0]},
                            {'id': parseInt(ZenDeskConfig.getValue(tenantAlias, 'fields', 'correspondingAuthorInstitution'), 10), 'value': publication.institution},
                            {'id': parseInt(ZenDeskConfig.getValue(tenantAlias, 'fields', 'journalName'), 10), 'value': publication.journalName},
                            {'id': parseInt(ZenDeskConfig.getValue(tenantAlias, 'fields', 'acceptanceDate'), 10), 'value': acceptanceDate},
                            {'id': parseInt(ZenDeskConfig.getValue(tenantAlias, 'fields', 'funders'), 10), 'value': funders}
                        ]
                    }
                };
