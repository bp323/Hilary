...
var ZenDeskConstants = require('./constants').ZenDeskConstants;
            ...
            _getOrCreateZendeskUser(client, user.displayName, userEmail, function(err, zenDeskUser) {
                ...
                var zenDeskTicket = {
                    'ticket': {
                        ...
                        'custom_fields': [
                            {'id': ZenDeskConstants.fields.OA_NUMBER, 'value': ticket.externalId},
                            {'id': ZenDeskConstants.fields.DOWNLOAD_LINK, 'value': downloadURL},
                            {'id': ZenDeskConstants.fields.PUBLICATION_TITLE, 'value': publication.displayName},
                            {'id': ZenDeskConstants.fields.DEPARTMENT, 'value': publication.department},
                            {'id': ZenDeskConstants.fields.CORRESPONDING_AUTHOR, 'value': publication.authors[0]},
                            {'id': ZenDeskConstants.fields.CORRESPONDING_AUTHOR_INSTITUTION, 'value': publication.institution},
                            {'id': ZenDeskConstants.fields.JOURNAL_TITLE, 'value': publication.journalName},
                            {'id': ZenDeskConstants.fields.ACCEPTANCE_DATE, 'value': acceptanceDate},
                            {'id': ZenDeskConstants.fields.FUNDERS, 'value': funders}
                        ]
                    }
                };
