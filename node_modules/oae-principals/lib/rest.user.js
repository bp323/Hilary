 ...
 */
OAE.tenantRouter.on('get', '/api/todo/todos', function(req, res) {
    PrincipalsAPI.getTodos(req.ctx, function(err, todos) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(200, todos);
 ...
 */
OAE.tenantRouter.on('post', '/api/todo/todos', function(req, res) {
    PrincipalsAPI.addTodo(req.ctx, req.body, function(err, todos) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(200, todos);
 ...
 * Mark a todo as 'done'
 */
OAE.tenantRouter.on('post', '/api/todo/:id/done', function(req, res) {
    PrincipalsAPI.markTodoAsDone(req.ctx, req.params.id, req.body.done, function(err, todo) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(200, todo);
